                  ...
                  <div className="relative bg-black rounded-xl overflow-hidden">
                    ...
                    <div className="absolute bottom-3 left-0 right-0 flex justify-center gap-2">
                      <button
                        ...
                        className="px-4 py-2 bg-white/95 backdrop-blur-sm hover:bg-white text-gray-800 text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all flex items-center gap-1.5"
                      >
                      ...
                      <button
                        type="button"
                        onClick={stopCamera}
                        className="px-4 py-2 bg-red-500/95 backdrop-blur-sm hover:bg-red-600 text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all flex items-center gap-1.5"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
